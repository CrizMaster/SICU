...
import { FichaCatastral } from '../../../ficha-individual/models/fichaCatastral.model';
import { FichaCatastralFilter } from '../../../ficha-individual/models/fichaCatastralFilter.model';
...
export class BandejaOrdenComponent implements OnInit{
  ...
  displayedColumns: string[] = ['Dpto.', 
  'Prov.', 'Dist.', 'Sec.', 
  'Mz.', 'Lote', 'Estado Manzana', 'PersonalAsignado','accion'];
  ...
  constructor(
    private _asignacionCargaService: AsignacionCargaService,
  ...
  ngOnInit(): void {
    ...
    // this._asignacionCargaService.listarFichasCatastrales(this.filter).subscribe({
    //   next:(Data) => {
    //       this.loading = false;
    //       let datos = Data.data;
    ...
    // this._asignacionCargaService.DataTableFI.subscribe({
    //   next:(menuData) => {
