...
export class BandejaLoteOrdenComponent implements OnInit , OnDestroy {
    ...
    ngOnInit(): void {  
      ...
      let info: LoteResponse[] = [
        { id:1, codigoEstado:1, estado: 'Formulario en proceso', nroLote: '01', totalUC: 4, fechaAsignacion: '04/10/2023 15:15', fechaSicronizacion: '' },
        { id:2, codigoEstado:2, estado: 'Pendiente Formulario', nroLote: '02', totalUC: 0, fechaAsignacion: '03/10/2023 15:35', fechaSicronizacion: '' },
        { id:3, codigoEstado:2, estado: 'Pendiente Formulario', nroLote: '03', totalUC: 0, fechaAsignacion: '02/10/2023 10:00', fechaSicronizacion: '' },
        { id:4, codigoEstado:2, estado: 'Pendiente Formulario', nroLote: '04', totalUC: 0, fechaAsignacion: '05/10/2023 11:15', fechaSicronizacion: '' }
      ]
