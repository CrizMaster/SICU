...
@Component({
    selector: 'app-otra-instalacion-bc-modal',
    templateUrl: './otra-instalacion-bc-modal.component.html',
    styleUrls: ['./otra-instalacion-bc-modal.component.css'],
    providers: [
      {
        provide: DateAdapter,
...
export class OtraInstalacionBcModalComponent implements OnInit, OnDestroy {
    ...
    constructor(
      public dialogRef: MatDialogRef<OtraInstalacionBcModalComponent>,
